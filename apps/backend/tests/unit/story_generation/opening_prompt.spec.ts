  ...
  test('assembles every opening source in a stable order', ({ assert }) => {
      ...
      charactersPresent: [
        {
          ...
          initialMood: 'Guarded.',
          initialStatus: 'Keeping watch.',
          initialMemory: 'Mara is a stranger.',
          sortOrder: 20,
        },
        {
          key: 'choir-child',
          ...
          initialMood: 'Curious.',
          initialStatus: 'Waiting by the altar.',
          initialMemory: 'Mara asked about the bell.',
          sortOrder: 10,
        },
      ],
    }
    ...
    assert.equal(
      ...
      [
        ...
        'Current status: Waiting by the altar.',
        'Player memory: Mara asked about the bell.',
        '',
        ...
        'Current status: Keeping watch.',
        'Player memory: Mara is a stranger.',
        '[/CHARACTERS_PRESENT]',
        '',
