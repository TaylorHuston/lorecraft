...
- Manual visual confirmation of the reconciled `S3/R1-S3` session states and `S3/R2-S1` sign-out presentation remains pending for the active UI reconciliation.
