...
| S3/R1-S4 | `apps/frontend/src/workspace/WorkspacePage.tsx#WorkspacePage` | primary | Ends shared session when the authenticated World catalog or in-workspace Adventure deletion becomes unauthorized. |
...
| S3/R1-S4 | Automated test `apps/frontend/src/worlds/WorldRoutes.test.tsx#LC-001/S3/R1-S4 ends the shared session when the catalog reports unauthorized` | An unauthorized catalog refresh ends the shared session before the protected Workspace remains usable. | Passing 2026-07-22 |
