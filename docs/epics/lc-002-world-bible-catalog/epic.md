...
| S1/R1-S1, S1/R1-S3           | `apps/frontend/src/worlds/WorldRoutes.test.tsx` and `apps/frontend/src/workspace/WorkspacePage.stories.tsx` | Populated and empty catalog states.                                                                         | Passing 2026-07-17   |
