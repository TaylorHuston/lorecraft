...
| S1/R1-R5 full regression gates                                            | `apps/backend/tests/functional/adventure_api.spec.ts`, `apps/frontend/src/adventures/AdventureRoutes.test.tsx`, `apps/frontend/e2e/adventure-foundation.spec.ts`, and root `package.json` scripts                  | Backend 101-test, frontend 101-test, Storybook 64-test, build/typecheck/lint, and Playwright 7-test gates keep the complete deterministic Adventure foundation green together.                                                                                 | Passing 2026-07-16 |
