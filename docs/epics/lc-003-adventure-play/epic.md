...
| S1/R3-S9 and R3-S10 deployment support                                    | `deploy/container-contract.test.mjs`, `deploy/release-command.test.mjs`, and `scripts/image-workflow.test.mjs`                                                                                                                                                                                                                                               | Static production contracts cover separate API/worker commands, five-second polling, loopback-only gateway, a trusted private-HTTPS proxy scheme, tolerant production env/state handling, one-shot migration, immutable `main` images, health sequencing, and application rollback after start or health failure.                           | Supporting automation passing 2026-07-18; live deployment pending |
