...
| S1/R5-S7 | Automated tests `apps/backend/tests/functional/adventure_player_debug_state.spec.ts#LC-003/S1/R5-S7` owner mutation, non-owner, and invalid-Location/active-turn cases | Owner-only Player Debug persistence changes no frozen canon, revision, or turn data; invalid, non-owner, and resolving requests fail closed. | Present 2026-07-23; guarded execution pending an acknowledged disposable database |
