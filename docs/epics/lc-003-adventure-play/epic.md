...
| S1/R2-S1, S1/R2-S2, S1/R2-S3           | `apps/backend/database/migrations/1784233200000_add_frozen_world_source_foundation.ts`, `apps/backend/database/migrations/1784424000000_reconcile_character_state_bounds.ts`, and `apps/backend/app/services/stormbound_chapel_seed.ts#seedStormboundChapel` | persistence | Enforces frozen-source/default constraints, reconciles blank legacy state without truncating authored content, and provides the repeatable playable starter World. |
...
| S1/R2-S1, S1/R2-S2, S1/R2-S3                                         | `apps/backend/tests/database/frozen_world_source_migration.spec.ts`, `apps/backend/tests/database/character_state_bounds_migration.spec.ts`, `apps/backend/tests/functional/world_version_publication.spec.ts`, `apps/backend/tests/functional/adventure_creation_service.spec.ts`, `apps/backend/tests/functional/adventure_query_service.spec.ts`, `apps/backend/tests/functional/world_catalog.spec.ts`, and `apps/frontend/e2e/starter-world.spec.ts` | Immutable source/default constraints, stable snapshot publication, complete nonblank seeded initial NPC state, legacy-state reconciliation without truncation, non-mutating fallback for legacy blank frozen snapshots, initial binding, playability conflicts, and an existing Adventure retaining its frozen NPC while a newly created Adventure uses published canon. | Passing 2026-07-20 against a guarded isolated schema |
...
| S2/R1-S1, S2/R1-S2, S2/R1-S3, S2/R2-S1, S2/R2-S2, S2/R2-S3, S2/R2-S5, S2/R3-S3, S2/R3-S4, S2/R4-S1, S2/R4-S2, S2/R4-S4, S2/R5-S1, S2/R5-S2, S2/R5-S3, S2/R5-S4                                                   | `apps/frontend/e2e/adventure-foundation.spec.ts` and `apps/frontend/e2e/fake-story-provider.mjs`                                                                                                                                                                                                                                                                                                                             | The seeded Adventure resolves Act, private Guide, and confirmed Pass through the real worker; it asserts authoritative post-turn NPC Mood/Status/Memory refresh in the Scene card, while reload, same-owner concurrency, failure recovery, reset, owner isolation, and desktop/mobile layouts remain coherent. | Passing 2026-07-20 against a guarded isolated schema                                             |
...
| Requirement / Scenario                 | Evidence                                                                                                                               | Proves                                                                                                                                                                                  | Status                                            |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| S3/R1-S1, S3/R1-S2, S3/R2-S1, S3/R3-S1, S3/R3-S2, S3/R3-S3 | `apps/frontend/src/adventures/AdventureWorkbench.test.tsx`, `apps/frontend/src/adventures/tuyauAdventureApi.test.ts`, and `apps/frontend/src/adventures/AdventurePage.stories.tsx#DebugNpcEditor` | Present-NPC list, complete-card selection/back behavior, local Debug autosave draft, actionable field-level validation/recovery, focus-preserving authoritative refresh, selected-editor continuity after a Location move, exact 120/320/500 client guidance, keyboard/mobile layout fixtures, and no horizontal overflow assertions. | Passing 2026-07-20                                |
| S3/R3-S1, S3/R3-S2 | `apps/backend/tests/unit/adventure_validation.spec.ts`, `apps/backend/tests/unit/adventure_mutation_policy.spec.ts`, `apps/backend/tests/unit/story_generation/adventure_state_extractor.spec.ts`, and `apps/backend/tests/database/character_state_bounds_migration.spec.ts` | Debug input, untrusted extractor proposals, and legacy persisted state share whitespace-aware nonblank `120/320/500` bounds; nonblank authored values survive reconciliation. | Passing 2026-07-20 against a guarded isolated schema |
...
| S3/R1-S3, S3/R3-S1                     | `apps/frontend/e2e/adventure-foundation.spec.ts` and `apps/frontend/e2e/fake-story-provider.mjs` | A fixture-controlled completed Act refreshes the selected current-Scene NPC's authoritative Mood, Status, and Memory values. | Passing 2026-07-20 on desktop and mobile against a guarded isolated schema |
| S3/R1-S1, S3/R2-S1, S3/R3-S1            | Storybook `Application/Adventures/Workbench/ReadyDesktop`, `ReadyMobile`, and `DebugNpcEditor`                                         | Directly inspected desktop NPC list and selected complete editor plus mobile Story-first Scene-to-card selection; all bounded editable fields render without horizontal overflow.           | Passing 2026-07-20                                |
