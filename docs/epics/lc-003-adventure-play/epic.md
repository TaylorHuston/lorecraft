...
| S1/R3-S6 and R3-S7                                                        | `apps/backend/tests/unit/story_generation/openai_compatible_story_generator.spec.ts` and `apps/backend/tests/unit/adventure_opening_policy.spec.ts`                                                                                                                                                                                                          | Provider-returned evidence contains bounded metadata only; raw bodies/headers are absent; retry classification, jitter, terminal-status handling, and bounded delta/date `Retry-After` are deterministic.                                                                                                                             | Passing 2026-07-18                                                |
...
| S1/R3-S9 and R3-S10 deployment support                                    | `deploy/container-contract.test.mjs`, `deploy/release-command.test.mjs`, and `scripts/image-workflow.test.mjs`                                                                                                                                                                                                                                               | Static production contracts cover separate API/worker commands, five-second polling, loopback-only gateway, one-shot migration, immutable `main` images, health sequencing, and application rollback planning.                                                                                                                        | Supporting automation passing 2026-07-18; live deployment pending |
