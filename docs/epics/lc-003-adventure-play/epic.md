...
- Related ADRs:
  ...
  - `docs/adrs/2026-07-18-revision-linked-adventure-state-mutations.md` (proposed)
...
| S2    | implemented    | partial      | Resolve a structured Game Master turn. | 2026-07-19    | Act, Pass, Guide, durable lifecycle, bounded consequences, and responsive turn workbench; database and live-provider verification gaps remain explicit. |
...
| S2/R1-S1, S2/R1-S2, S2/R1-S3, S2/R1-S4, S2/R1-S5, S2/R1-S6, S2/R2-S1, S2/R2-S2, S2/R2-S3, S2/R2-S4, S2/R2-S5, S2/R2-S6, S2/R3-S3, S2/R3-S4, S2/R4-S1, S2/R4-S2, S2/R4-S3, S2/R4-S4, S2/R4-S5, S2/R4-S6 | `apps/backend/tests/functional/adventure_turn_api.spec.ts`, `apps/backend/tests/functional/adventure_turn_submission_service.spec.ts`, `apps/backend/tests/functional/adventure_turn_worker.spec.ts`, `apps/backend/tests/database/adventure_aggregate_migration.spec.ts`, and `apps/backend/tests/database/adventure_mutation_state_migration.spec.ts` | API authorization/idempotency, worker lifecycle/finalization, transactional state isolation/reset/delete, data-bearing rollback refusal, and migration invariants against a guarded disposable Neon schema. | Passing 2026-07-19 |
| S2/R1-S1, S2/R1-S2, S2/R1-S3, S2/R2-S1, S2/R2-S2, S2/R3-S3, S2/R4-S1, S2/R4-S2, S2/R4-S4, S2/R5-S1, S2/R5-S2, S2/R5-S3, S2/R5-S4 | `apps/frontend/e2e/adventure-foundation.spec.ts` and `apps/frontend/e2e/fake-story-provider.mjs` | The seeded Adventure resolves Act, private Guide, and confirmed Pass through the real worker; committed state updates reach Player/Scene only after resolution; reset, reload, owner isolation, and desktop/mobile layouts remain coherent. | Passing 2026-07-19 |

#### Verification Gaps

- `S2/R2-S2`, `S2/R2-S5`, and `S2/R5-S3`: failure/retry/discard and concurrent-tab browser choreography is covered at functional/component boundaries, but awaits a dedicated browser journey.
