...
- `S3/R2-S2`, `S3/R3-S2`: Long sparse card and recovery confirmation remain pending; deterministic post-turn refresh and database-backed Debug-edit/owner-isolation evidence now pass.
